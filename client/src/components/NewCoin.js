            ...
            <div style={{height:"auto",padding:"15px",marginBottom:"10px"}} className='border border-solid border-dark'>
                ...
                <form className='d-flex flex-column justify-content-between' onSubmit={handleSubmit}>
                    <div id="group" className="d-flex flex-row justify-content-evenly form-group">
                        ...
                        <p className="text-danger">{errors.coinType?errors.coinType._message:""}</p>
                    </div>
                    
                    <div id="group" className="d-flex flex-row justify-content-evenly form-group">
                        <h4>Year:</h4>
                        <input onChange={(e)=>setYear(e.target.value)} type='number' className="form-control w-50"/>
                        <p className="text-danger">{errors.year?errors.year._message:""}</p>
                    </div>
                    
                    <div id="group" className="d-flex flex-row justify-content-evenly form-group">
                        <h4>Mint:</h4>
                        <input onChange={(e)=>setMint(e.target.value)} type='text' className="form-control w-50"/>
                        <p className="text-danger">{errors.mint?errors.coinmint._message:""}</p>
                    </div>
                    
                    <div id="group" className="d-flex flex-row justify-content-evenly form-group">
                        <h4>Denomination</h4>
                        <input onChange={(e)=>setDenomination(e.target.value)} type='text' className="form-control w-50"/>
                        <p className="text-danger">{errors.denomination?errors.denomination._message:""}</p>
                    </div>
                    
                    <div id="group" style={{paddingRight:"25%",marginRight:'25px'}} className="d-flex flex-row justify-content-evenly form-group">
                        <h4>Value:</h4>
                        <input onChange={(e)=>setValue(e.target.value)} type='number' className="form-control w-50"/>
                        
                    </div>
                    
                    <div id="group" style={{paddingRight:"19%"}} className="d-flex flex-row justify-content-evenly form-group">
                        <h4>Description:</h4>
                    ...
                    <div id="group" style={{paddingRight:"33%"}} className="d-flex flex-row justify-content-evenly form-group">
